        ...
        <div class="small-12">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="reset" id="right-label" value="Update" style="background: #0078A0; border: none; color: #fff; font-family: 'Helvetica Neue', sans-serif; font-size: 1em; padding: 10px;">
